...
- track plasmid exchange and identify key elements of carbapenem resistance spread in the gut microbiome
- identify key species and metabolic pathways that promote resistance to CRE colonization
- test strategies for CR-GNB colonization resistance in germ-free (gnotobiotic) mouse models
